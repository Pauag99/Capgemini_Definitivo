...
public interface PrestamoRepository extends CrudRepository<Prestamo, Long> {
    ...
    List<Prestamo> findAPrestamo(@Param("clientname") String clientname, @Param("gamename") String gamename, @Param("fechaprestamo") LocalDate fechaprestamo, @Param("fechadevolucion") LocalDate fechadevolucion);
    ...
    int countClientPrestamo(@Param("clientname") String clientname, @Param("fechaprestamo") LocalDate fechaprestamo, @Param("fechadevolucion") LocalDate fechadevolucion);
